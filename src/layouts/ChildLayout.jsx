      ...
      <Container maxWidth='sm' sx={{ pt: 11 }}>
        <Routes>
          ...
          <Route
            ...
            element={<InputCompletion />}
          />
          <Route path='/targets/*' element={<DetailTargets />} />
          <Route
            path='/user-completion/*'
            element={<UserCompletionByCategory />}
          />
          <Route
            path='/group-completion/*'
            element={<GroupCompletionByCategory />}
          />
          <Route
            exact
            path='/group-detail-completion/*'
            element={<GroupInputCompletion />}
          />
          <Route
            path='/person-completion/*'
            element={<PersonCompletionByCategory />}
          />
          <Route
            path='/person-completion'
            element={
          ...
          <Route
            exact
            path='/person-detail-completion/*'
            element={<PersonInputCompletion />}
          />
          <Route
            path='/profile/*'
            element={
          ...
          <Route
            path='/event-group-presence/*'
            element={<EventGroupPresence />}
          />
          <Route path='/reset-passwords/*' element={<ResetPassword />} />
          <Route path='/edit-profile' element={<EditProfile />} />
          <Route path='/edit-grade' element={<EditGrade />} />
          <Route
            path='/edit-profile-by-admin'
            element={<EditProfileByAdmin />}
          />
